...
class NovelsControllerTest < ActionController::TestCase
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post :create, novel: { doi: @novel.doi, price: @novel.price, student: @novel.student, title: @novel.title }
    end
  ...
  test "should update novel" do
    put :update, id: @novel, novel: { doi: @novel.doi, price: @novel.price, student: @novel.student, title: @novel.title }
    assert_redirected_to novel_path(assigns(:novel))
  end
